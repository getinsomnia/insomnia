...
export const _default = () => {
  const [targetPath, setTargetPath] = useState('Awaiting click...');

  const _handleItemClick = (...items: string[]) => {
...
export const SimpleAPI = () => {
  ...
  const _handleItemClick = (...items: any[]) => {
    setTargetPath(items.join(' > '));
  };
...
export const Badges = () => {
  const [clickedBadge, setClickedBadge] = useState('Awaiting click...');
